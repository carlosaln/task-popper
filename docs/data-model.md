...
| `due_time` | `str \| None` | Pinned start time for today's schedule: `"HH:MM"`. Scheduler places task starting exactly at this time. Ignored (but not cleared) once the time has passed. |
